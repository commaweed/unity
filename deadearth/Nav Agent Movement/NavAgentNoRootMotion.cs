...
/// <summary>
/// Root motion disabled on animator.  NO ROOT MOTION!
/// 
...
/// 
/// Navigation will be at its most accuracy.
/// </summary>
...
public class NavAgentNoRootMotion : MonoBehaviour {
   ...
   private void InitializeAnimatorController() {
      ...
      animatorController.runtimeAnimatorController = Resources.Load("NoRootMotionAuthority") as RuntimeAnimatorController;
   ...
   private float CalculateHorizontalValue() {
      ...
      // clamp it to our speed range (from blend controller)
