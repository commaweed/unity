...
/// 
/// No foot sliding at all but at the cost of navigation accuracy.  Also not very realistic in certain situations.
/// </summary>
...
public class NavAgentRootMotion : MonoBehaviour {
   ...
   private void OnAnimatorMove() {
      // have our animator controller handle the rotation
   ...
   private void InitializeAnimatorController() {
      ...
      this.withWalkController = LoadRuntimeAnimatorController("RootMotionAuthority");
      this.withRunController = LoadRuntimeAnimatorController("RootMotionAuthorityWithRun");
